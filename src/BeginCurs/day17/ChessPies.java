package BeginCurs.day17;

public enum ChessPies {
    ...
    private  String representetion;

    ChessPies(double value, String representetion) {
        this.value = value;
        this.representetion = representetion;
    }

    public String getRepresentetion() {
